...
define('NOTIFYER_TWITTER_TWEET_MESSAGE_TEMPLATE', '');
...
define('TWITTER_TWEET_TEMPLATE', '');
define('TWITTER_TWEET_TEMPLATE_39', '');
define('TWITTER_TWEET_TEMPLATE_310', '');
define('TWITTER_TWEET_TEMPLATE_40', '');
